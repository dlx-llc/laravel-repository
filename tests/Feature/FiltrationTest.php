...
#[Group('feature')]
final class FiltrationTest extends TestCase
{
    public function testFiltration(): void
    {
        ...
        request()->replace([
            ...
            'perPage' => 10,
            'filters' => '[
                {"attr": "name", "operator":"like", "value": "premium"},
                {"boolean": "or", "attr": "category.name", "operator": "=", "value": "Premium Watches"},
                {"boolean": "or", "attr": "labels.name", "operator": "included", "value": ["Premium Sedan", "Premium Foldable"]}
            ]',
        ]);

 ...
 * @method static PaginationContract getRequestPagination(bool $require = true, ?string $pageKey = null, ?string $perPageKey = null)  Creates a new pagination object using the parameters of the request.
